...
object Proc_PlanPruebas_PermisosFull {
  def main(args: Array[String]): Unit = {
    val huemulLib = new huemul_BigDataGovernance("01 - Proc_PlanPruebas_PermisosFull",args,globalSettings.Global)
    ...
    try {
      ...
      IdTestPlan = Control.RegisterTestPlan(TestPlanGroup, "getWhoCanRun_executeFull","Pudo agregar acceso", "no Pudo agregar acceso", s"Pudo agregar acceso", false)
