...
object Proc_PlanPruebas_CargaMaster_mes_paso_2_selective {
  def main(args: Array[String]): Unit = {
    ...
    try {
      ...
      if (!TablaMaster.executeSelectiveUpdate("DF_Final",periodo_mes, org.apache.spark.storage.StorageLevel.DISK_ONLY)) {
      ...
      if (!TablaMaster4.executeSelectiveUpdate("DF_Final",null, org.apache.spark.storage.StorageLevel.DISK_ONLY)) {
      ...
      Control.NewStep("executeSelectiveUpdate")
      if (!TablaMaster5.executeSelectiveUpdate("DF_Final",null, org.apache.spark.storage.StorageLevel.DISK_ONLY)) {
